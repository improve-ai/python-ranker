...
class TestEncoder(TestCase):
    ...
    def test_hash_to_feature_name_overflow(self):
        ...
        offset = 0
        feature_name_no_offset = cfe.hash_to_feature_name(hash_, offset=offset)
        assert feature_name_no_offset == 'ffffffff'

        offset = 1
        feature_name_offset_1 = cfe.hash_to_feature_name(hash_, offset=offset)
        ...
        feature_name_offset_2 = cfe.hash_to_feature_name(hash_, offset=offset)
        assert feature_name_offset_2 == 'ffffffff'

        offset = 2 ** 32 + 1
        # 0000000000000000000000000000000100000000000000000000000000000000
        feature_name_offset_3 = cfe.hash_to_feature_name(hash_, offset=offset)
        assert feature_name_offset_3 == '00000000'

        offset = 2 ** 32 + 2
        # 0000000000000000000000000000000100000000000000000000000000000000
        feature_name_offset_4 = cfe.hash_to_feature_name(hash_, offset=offset)
        assert feature_name_offset_4 == '00000001'

        offset = 3 * 2 ** 32
        # 0000000000000000000000000000000100000000000000000000000000000000
        feature_name_offset_5 = cfe.hash_to_feature_name(hash_, offset=offset)
        assert feature_name_offset_5 == 'ffffffff'

        offset = 3 * 2 ** 32 + 1
        # 0000000000000000000000000000000100000000000000000000000000000000
        feature_name_offset_6 = cfe.hash_to_feature_name(hash_, offset=offset)
        assert feature_name_offset_6 == '00000000'

        offset = 3 * 2 ** 32 + 2
        # 0000000000000000000000000000000100000000000000000000000000000000
        feature_name_offset_7 = cfe.hash_to_feature_name(hash_, offset=offset)
